 ...
 *    via `@sudobility/shaperouter_client`'s `useKeys` hook.
...
import { type FirebaseIdToken, useKeys } from '@sudobility/shaperouter_client';
...
export interface UseKeysManagerConfig {
  /** Base URL of the ShapeRouter API (e.g., "https://api.shaperouter.com") */
  baseUrl: string;
 ...
 *
 * Wraps `@sudobility/shaperouter_client`'s `useKeys` hook and adds:
 ...
 *   baseUrl: "https://api.shaperouter.com",
 *   networkClient,
 *   entitySlug: "my-org",
 *   token: firebaseToken,
 * });
